...
<p align="center">
  [<a href="https://discord.gg/TgQ3Cu2F7A">Join Discord Server</a>] [<a href="https://nova.moeru.ai">Try it</a>] [<a href="https://github.com/btechioi/NOVA/blob/main/docs/README.zh-CN.md">简体中文</a>] [<a href="https://github.com/btechioi/NOVA/blob/main/docs/README.ja-JP.md">日本語</a>] [<a href="https://github.com/btechioi/NOVA/blob/main/docs/README.ru-RU.md">Русский</a>] [<a href="https://github.com/btechioi/NOVA/blob/main/docs/README.vi.md">Tiếng Việt</a>] [<a href="https://github.com/btechioi/NOVA/blob/main/docs/README.fr.md">Français</a>] [<a href="https://github.com/btechioi/NOVA/blob/main/docs/README.ko-KR.md">한국어</a>]
</p>

<p align="center">
  <a href="https://deepwiki.com/btechioi/NOVA"><img src="https://deepwiki.com/badge.svg"></a>
  <a href="https://github.com/btechioi/NOVA/blob/main/LICENSE"><img src="https://img.shields.io/github/license/btechioi/NOVA.svg?style=flat&colorA=080f12&colorB=1fa669"></a>
  <a href="https://discord.gg/TgQ3Cu2F7A"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdiscord.com%2Fapi%2Finvites%2FTgQ3Cu2F7A%3Fwith_counts%3Dtrue&query=%24.approximate_member_count&suffix=%20members&logo=discord&logoColor=white&label=%20&color=7389D8&labelColor=6A7EC2"></a>
  <a href="https://x.com/proj_nova"><img src="https://img.shields.io/badge/%40proj__nova-black?style=flat&logo=x&labelColor=%23101419&color=%232d2e30"></a>
...
<p float="left" align="center">
  ...
  <a href="https://github.com/btechioi/NOVA/releases/download/v0.9.0/NOVA-0.9.0-windows-x64-setup.exe">
    <picture>
      <source
        width="33%"
  ...
  <a href="https://github.com/btechioi/NOVA/releases/download/v0.9.0/NOVA-0.9.0-darwin-arm64.dmg">
    <picture>
      <source
        width="33%"
  ...
  <a href="https://github.com/btechioi/NOVA/releases/latest">
    <picture>
      <source
        width="33%"
...
<p align="center">
  <a href="https://www.producthunt.com/products/nova?embed=true&utm_source=badge-featured&utm_medium=badge&utm_source=badge-nova" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=993524&theme=neutral&t=1752696535380" alt="NOVA - A&#0032;container&#0032;of&#0032;cyber&#0032;living&#0032;souls&#0044;&#0032;re&#0045;creation&#0032;of&#0032;Neuro&#0045;sama | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>
  <a href="https://trendshift.io/repositories/14636" target="_blank"><img src="https://trendshift.io/api/badge/repositories/14636" alt="btechioi%2FNOVA | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>

> Heavily inspired by [Neuro-sama](https://www.youtube.com/@Neurosama)

> [!TIP]
> On Windows, you can also install NOVA with [Scoop](https://scoop.sh/):
>
> ```powershell
> scoop bucket add nova https://github.com/btechioi/NOVA
> scoop install nova/nova
> ```
...
> [!NOTE]
>
> We've got a whole dedicated organization [@proj-nova](https://github.com/proj-nova) for all the sub-projects born from Project NOVA. Check it out!
>
> RAG, memory system, embedded database, icons, Live2D utilities, and more!

> [!TIP]
> We have a translation project on [Crowdin](https://crowdin.com/project/proj-nova). If you find any inaccurate translations, feel free to contribute improvements there.
...
Therefore, this project, NOVA, offers another possibility here: **let you own your digital life, cyber living, easily, anywhere, anytime**.

## DevLogs We Posted & Recent Updates

- [DevLog @ 2026.03.23](https://nova.moeru.ai/docs/en/blog/DevLog-2026.03.23/) on March 23, 2026
- [DevLog @ 2026.03.14](https://nova.moeru.ai/docs/en/blog/DevLog-2026.03.14/) on March 14, 2026
- [DevLog @ 2026.02.16](https://nova.moeru.ai/docs/en/blog/DevLog-2026.02.16/) on February 16, 2026
- [DevLog @ 2026.01.01](https://nova.moeru.ai/docs/en/blog/DevLog-2026.01.01/) on January 1, 2026
- [DevLog @ 2025.10.20](https://nova.moeru.ai/docs/en/blog/DevLog-2025.10.20/) on October 20, 2025
- [DevLog @ 2025.08.05](https://nova.moeru.ai/docs/en/blog/DevLog-2025.08.05/) on August 5, 2025
- [DevLog @ 2025.08.01](https://nova.moeru.ai/docs/en/blog/DevLog-2025.08.01/) on August 1, 2025
- [DreamLog 0x1](https://nova.moeru.ai/docs/en/blog/dreamlog-0x1/) on June 16, 2025
- ...more on [documentation site](https://nova.moeru.ai/docs/en/)
...
>
> Don't worry, while the Web browser version is meant to give an insight into how much we can push and do inside browsers and webviews, we will never fully rely on this. The desktop version of NOVA is capable of using native [NVIDIA CUDA](https://developer.nvidia.com/cuda-toolkit) and [Apple Metal](https://developer.apple.com/metal/) by default (thanks to HuggingFace & the beloved [candle](https://github.com/huggingface/candle) project), without any complex dependency management. Considering the tradeoff, it is partially powered by Web technologies for graphics, layouts, animations, and the WIP plugin system for everyone to integrate things.

This means that **NOVA is capable of running on modern browsers and devices** and even on mobile devices (already done with PWA support). This brings a lot of possibilities for us (the developers) to build and extend the power of NOVA VTuber to the next level, while still leaving the flexibility for users to enable features that require TCP connections or other non-Web technologies such as connecting to a Discord voice channel or playing Minecraft and Factorio with friends.

> [!NOTE]
>
> We are still in the early stage of development where we are seeking out talented developers to join us and help us to make NOVA a reality.
>
...
>
> Even if you are a big fan of React, Svelte or even Solid, we welcome you. You can open a sub-directory to add features that you want to see in NOVA, or would like to experiment with.
>
...
>
> **If you are interested, why not introduce yourself here? [Would like to join part of us to build NOVA?](https://github.com/btechioi/NOVA/discussions/33)**
...
### Stage Web (Browser Version at [nova.moeru.ai](https://nova.moeru.ai))
...
A Nix package for Tamagotchi is included. To run NOVA with Nix, first make sure to enable flakes, then run:

```shell
nix run github:btechioi/NOVA
```
...
- [Awesome AI VTuber](https://github.com/proj-nova/awesome-ai-vtuber): A curated list of AI VTubers and related projects
...
- [WebAI: Realtime Voice Chat](https://github.com/proj-nova/webai-realtime-voice-chat): Full example of implementing ChatGPT's realtime voice from scratch with VAD + STT + LLM + TTS.
- [`@proj-nova/drizzle-duckdb-wasm`](https://github.com/btechioi/NOVA/tree/main/packages/drizzle-duckdb-wasm/README.md): Drizzle ORM driver for DuckDB WASM
- [`@proj-nova/duckdb-wasm`](https://github.com/btechioi/NOVA/tree/main/packages/duckdb-wasm/README.md): Easy to use wrapper for `@duckdb/duckdb-wasm`
- [NOVA Factorio](https://github.com/moeru-ai/airi-factorio): Allow NOVA to play Factorio.
- [NOVA DomeKeeper](https://github.com/proj-nova/game-playing-ai-dome-keeper): Allow NOVA to play DomeKeeper.
...
flowchart TD
  ...
  style NOVA fill:#fcf7f7,stroke:#333,stroke-width:1px
...
<p align="center">
  <strong>Thank you for supporting Project NOVA through OpenCollective, Patreon, and Ko-fi.</strong>
</p>

<p align="center">
  <img src="./docs/content/public/assets/sponsors/sponsors.svg" alt="Project NOVA supporters" />
</p>

## Special Thanks

Special thanks to all contributors for their contributions to Project NOVA ❤️

<a href="https://github.com/btechioi/NOVA/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=btechioi/NOVA" />
</a>

## Star History

<a href="https://star-history.com/#btechioi/NOVA&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=btechioi/NOVA&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=btechioi/NOVA&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=btechioi/NOVA&type=Date" />
  </picture>
</a>
