---
title: Contributing
description: Contributing to Project NOVA
---
...
Click on the **Fork** button on the top right corner of the [moeru-ai/airi](https://github.com/btechioi/NOVA) page.
...
```shell
git remote add upstream https://github.com/btechioi/NOVA.git
```
...
Navigate to [moeru-ai/airi](https://github.com/btechioi/NOVA) page, click on the **Pull requests** tab, and click on the **New pull request** button, click on the **Compare across forks** link, and select your fork repository.
