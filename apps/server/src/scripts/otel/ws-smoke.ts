 ...
 *
 * Usage:
 *   pnpm -F @proj-nova/server exec node --import tsx ./src/scripts/otel/ws-smoke.ts
 *
 * With OTel diagnostic logs (verbose, includes export cycles):
 *   OTEL_DEBUG=true pnpm -F @proj-nova/server exec node --import tsx ./src/scripts/otel/ws-smoke.ts
 */
