...
import Header from '@proj-nova/stage-layouts/components/Layouts/Header.vue'
import InteractiveArea from '@proj-nova/stage-layouts/components/Layouts/InteractiveArea.vue'
import MobileHeader from '@proj-nova/stage-layouts/components/Layouts/MobileHeader.vue'
import MobileInteractiveArea from '@proj-nova/stage-layouts/components/Layouts/MobileInteractiveArea.vue'
import workletUrl from '@proj-nova/stage-ui/workers/vad/process.worklet?worker&url'

import { BackgroundProvider } from '@proj-nova/stage-layouts/components/Backgrounds'
import { useBackgroundThemeColor } from '@proj-nova/stage-layouts/composables/theme-color'
import { useBackgroundStore } from '@proj-nova/stage-layouts/stores/background'
