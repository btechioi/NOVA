...
import type { EmotionPayload } from '@proj-nova/stage-ui/constants/emotions'
import type { ChatProvider, SpeechProviderWithExtraOptions } from '@xsai-ext/providers/utils'

import { createPlaybackManager, createSpeechPipeline } from '@proj-nova/pipelines-audio'
import { ThreeScene } from '@proj-nova/stage-ui-three'
import { animations } from '@proj-nova/stage-ui-three/assets/vrm'
import { useDelayMessageQueue, useEmotionsMessageQueue } from '@proj-nova/stage-ui/composables/queues'
import { llmInferenceEndToken } from '@proj-nova/stage-ui/constants'
import { EMOTION_EmotionMotionName_value, EMOTION_VRMExpressionName_value, EmotionThinkMotionName } from '@proj-nova/stage-ui/constants/emotions'
import { useAudioContext, useSpeakingStore } from '@proj-nova/stage-ui/stores/audio'
