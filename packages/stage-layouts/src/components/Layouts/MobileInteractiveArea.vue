...
import type { ChatHistoryItem } from '@proj-nova/stage-ui/types/chat'
import type { ChatProvider } from '@xsai-ext/providers/utils'

import { isStageTamagotchi } from '@proj-nova/stage-shared'
import { useThreeViewControl } from '@proj-nova/stage-ui-three'
import { ChatHistory, HearingConfigDialog } from '@proj-nova/stage-ui/components'
import { ChatSessionsDrawer } from '@proj-nova/stage-ui/components/scenarios/chat'
import { useAudioAnalyzer } from '@proj-nova/stage-ui/composables'
import { useAudioContext } from '@proj-nova/stage-ui/stores/audio'
...
import { useChatStreamStore } from '@proj-nova/stage-ui/stores/chat/stream-store'
import { useL2dViewControl } from '@proj-nova/stage-ui/stores/live2d'
...
import { BasicTextarea, useTheme } from '@proj-nova/ui'
