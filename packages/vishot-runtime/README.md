...
- framework-specific bindings through subpath exports such as `@proj-nova/vishot-runtime/vue`
...
```ts
import { markScenarioReady, resetScenarioReady } from '@proj-nova/vishot-runtime'
import {
  ScenarioCanvas,
  ScenarioCaptureRoot,
  ScreenNavigator,
  ...
  useSceneNavigation,
} from '@proj-nova/vishot-runtime/vue'
```
