...
- `@proj-nova/stage-ui-three/trace`: local Eventa trace bus and snapshot helpers.
- `@proj-nova/stage-ui-three/composables/vrm`: VRM loading and animation helpers.
- `@proj-nova/stage-ui-three/utils/vrm-preview`: one-off VRM preview rendering.
...
`@proj-nova/stage-ui-three/trace` provides:
...
- Use `@proj-nova/stage-ui-three/trace` when you need Three/VRM runtime telemetry without routing through Vue parent chains.
