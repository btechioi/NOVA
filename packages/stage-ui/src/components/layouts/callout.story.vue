  ...
  >
    ...
    >
      <Callout>
        <div>
          ...
          <div>
            The Project NOVA theme, powered by our <a decoration-underline decoration-dashed href="https://github.com/proj-nova/chromatic">Chromatic</a> design system.
          </div>
        </div>
      </Callout>
    </Variant>
    ...
    >
      <Callout theme="violet">
        <div>
          <div>
            NOVA is running pure locally in your browser, and we will never steal your credentials for AI / LLM providers. But keep in mind that your API keys are sensitive information. Make sure to keep them safe and do not share them with anyone.
          </div>
          <div>
            NOVA is open sourced at <div inline-flex translate-y-1 items-center gap-1>
