...
export const beatSyncGetInputByteTimeDomainDataInvokeEventa = defineInvokeEventa<Uint8Array<ArrayBuffer>>('eventa:invoke:electron:beat-sync:get-input-byte-time-domain-data')
